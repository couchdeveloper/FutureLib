...
struct Synchronize {
    ...
    let sync_queue: dispatch_queue_t
    ...
    */
    init(name: String) {
        ...
        sync_queue = dispatch_queue_create(name, dispatch_queue_attr_make_with_qos_class(DISPATCH_QUEUE_CONCURRENT, QOS_CLASS_USER_INTERACTIVE, 0))
